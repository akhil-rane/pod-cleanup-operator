...
# craftdemo.com/pod-cleanup-operator-bundle:$VERSION and craftdemo.com/pod-cleanup-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= craftdemo.com/pod-cleanup-operator
